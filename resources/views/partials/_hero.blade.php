 <section class="hero relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
     <div class="content z-10">
         <h1 class="text-2xl font-bold uppercase text-white">
             Welcome to PureInsight - Where Clarity Meets Wisdom
         </h1>
         <p class="text-base text-gray-200 font-bold my-4 text-xs sm:text-base">
